        ...
        <Row>
          <Column>
            ...
            <p>
              ...
              Agile methodologies, such as Scrum.1000+ hours of personal coding.
            </p>
            <br></br>
          ...
          <Column>
            <Heading id="projects">&#60;Projects&#47;&#62;</Heading> <Divider />
            <Row>
              <SubTitle>LunaVines</SubTitle>{" "}
              <SocialIcons>
                <SocialIconLink
                  href={
                    "https://www.loom.com/share/c10c71a0760a41a7b7e7d61a078a644c"
                  }
                  target="_blank"
                  aria-label="LunaVines Loom Walk Through"
                >
                  <MdOndemandVideo />
                </SocialIconLink>
                <SocialIconLink
            ...
            <p>
              For wine lovers looking to visit biodynamic vineyards according to
              the moon's zodiac phase.{" "}
            </p>
            ...
            <p>
              ...
              curation and copy for the weekly e-newsletter of 12k+ subscribers
              and investors’ e-newsletter of 900.
            </p>
            <br></br>
            <SubTitle>Brand Director</SubTitle>
            <p>• Grew from Marketing Manager to sitting on the Board.</p>
            <p>
              • Co-founded a visually lead street food concept called BOB's
              Lobster (listed as Top Food Trucks by Lonely Planet)
            </p>
          </Column>
        </Row>
      </Page>
